...
// It's purpose is to create new article instances. It's capitalized because it's a constructor function. This' refers to new object instance properties. rawDataObj represents the perameters passed in a new instance
...
Article.prototype.toHtml = function() {
    ...
    // $newArticle.find('time').text(this.publishedOn); // don't think I need this, doesn't appear to do anything
